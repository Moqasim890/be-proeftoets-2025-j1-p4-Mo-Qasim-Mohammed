...
(Merk, Model, Type, Prijs, Materiaal, Gewicht, Releasedatum, IsActief, Opmerking, DatumAangemaakt, DatumGewijzigd)
VALUES
('Nike', 'Air Jordan 1', 'Basketbal', 120.00, 'Leer', 400, '2021-06-01', 1, NULL, SYSDATE(6), SYSDATE(6)),
('Adidas', 'Yeezy Boost 350', 'Casual', 180.00, 'Synthetisch', 380, '2022-01-15', 1, NULL, SYSDATE(6), SYSDATE(6)),
('New Balance', 'Pixel 9 Pro', 'Hardloop', 95.00, 'Mesh', 290, '2023-08-10', 1, NULL, SYSDATE(6), SYSDATE(6));
